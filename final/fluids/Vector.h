...
public:
	union
	{
		...
		/**
		 * First element of vector, alias u		 
		 */
		T u;
	};
	...
	union
	{
		...
		/**
		 * Second element of vector, alias v.
...
public:
	...
	union
	{
		...
		/**
		 * First element of vector, alias s (HSV)		 
		 */
		T h;
	...
	union
	{
		...
		T y;
		/**
		 * Second element of vector, alias s (HSV).		 
		 */
		T s;
		/**
	...
	union
	{
		...
		/**
		 * Third element of vector, alias for V (HSV)		 
		 */
		T v;
		/**
	...
	{
		Vector3<T> normalized = Vector3<T>(x, y, z);
